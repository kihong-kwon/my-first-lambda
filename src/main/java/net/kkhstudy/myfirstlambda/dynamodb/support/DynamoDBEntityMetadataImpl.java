...
public class DynamoDBEntityMetadataImpl<T> implements DynamoDBEntityMetadata<T> {
    ...
    /**
     * Creates a new {@link DynamoDBEntityMetadataImpl} for the given domain
     * type.
     *
     * @param domainType
     *            must not be {@literal null}.
     */
    public DynamoDBEntityMetadataImpl(final Class<T> domainType) {
